...
{newIssuedBook && newIssuedBook.map(book=>{
    ...
    return <tr key={book._id} >
        ...
        <td>
             ...
             <button onClick={() => dispatch(issuedReq(book._id,book.bookId))} className="btn btn-success">Accept</button> { "  "}
             <button onClick={() => dispatch(issuedReqDeletedByAdmin(book._id,book.bookId,false))} className="btn btn-danger">Reject</button>
        </td>
